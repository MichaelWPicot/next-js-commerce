...
const Header: FunctionComponent = () => {
    ...
    return (
        <header className=" relative dark-mode min-w-screen ">
            <nav aria-label="Top" className="flex-row gap-x-8 flex-grow mx-auto sm:px-6 lg:px-8">
                <div className="relative flex-grow flex px-4 pb-14 sm:static sm:px-0 sm:pb-0 ">
                    <div className="h-16 flex items-center justify-between mx-auto">
                        {/* Logo */}
                        <div className="flex-1 mx-auto gap-x-8 flex-grow flex items-center ">
